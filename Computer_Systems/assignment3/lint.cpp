...
ast copy_class_var_decs(ast t)
{
    ...
    if ( ndecs == 0 )
        ...
        return create_class_var_decs(add_ann_comments(get_ann(t), "private:"),decs) ;
}
...
ast copy_subr_decs(ast t)
{
    ...
    if ( size == 0 )
        ...
        return create_subr_decs(add_ann_comments(get_ann(t), "public:"), decs) ;
}
...
ast copy_statements(ast t)
{
    ...
    if ( unreachable == true )
        return create_statements(add_ann_warnings(get_ann(t), "Unreachable"), decs) ;
